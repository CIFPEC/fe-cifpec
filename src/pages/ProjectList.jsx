          ...
          <div className="col-12 col-lg-10">
            <div className="card p-4 shadow-sm">
              <div className="d-flex flex-column flex-md-row justify-content-between align-items-start align-items-md-center mb-3">
                <h6 className="fw-bold mb-3 mb-md-0">Project List{currentUser?.userCourse?.courseName ? ` - ${currentUser.userCourse.courseName}` : ""}</h6>
          ...
          <Modal.Body>
            ...
            <Form>
              ...
              <Form.Group className="mb-3 me-5">
                ...
                <Form.Control className="border ps-2" type="text" placeholder="Contoh: B12" value={boothNo} onChange={e => setBoothNo(e.target.value)} />
              </Form.Group>
            </Form>
          </Modal.Body>
          <Modal.Footer>
